...
router.post('/crear', async (req, res) => { // Define una ruta POST en '/crear' para crear un nuevo paciente
    try {
...
router.put('/modificar/:id', async (req, res) => { // Define una ruta PUT en '/modificar/:id' para modificar un paciente existente
    try {
        console.log('Numero id ',req.params.id)
        console.log('Body: ', req.body)
         const respuesta = await Paciente.update(req.body,  { // Intenta actualizar el paciente con los datos enviados en el cuerpo de la solicitud (req.body)
